...
--> statement-breakpoint
ALTER TABLE "product" ADD CONSTRAINT "product_showcase_id_showcase_id_fk" FOREIGN KEY ("showcase_id") REFERENCES "public"."showcase"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
